...
# --- MODIFICATION 1: Add project root to Python path ---
import sys
from pathlib import Path

# This is necessary for Alembic to find the 'backend' module
root_dir = Path(__file__).resolve().parents[2]
sys.path.append(str(root_dir))
# --------------------------------------------------------

import os
from dotenv import load_dotenv # MODIFICATION 2: Import dotenv
...
# --- MODIFICATION 2: Load the .env file ---
...
def run_migrations_online() -> None:
    ...
    """
    # --- MODIFICATION 4: Set the URL from the environment ---
